...
export default {
    ...
    data () {
        ...
        //表格内容
            columns9: [{title: '项目名称', align: 'center', key: 'hpobj'},{title: '地区', align: 'center', key: 'area'},{title: '调研对象', align: 'center', key: 'robj'},{title: '调研编号', align: 'center', key: 'rnum'},{title: '区域代理人', align: 'center', key: 'regionalper'},
                {title: '发送消息人姓名', align: 'center', key: 'msgsdper'},{title: '联系方式', align: 'center', key: 'contact'},{title: '反馈类型', align: 'center', key: 'fdbacktype'},{title: '时间', align: 'center', key: 'time'}],
            data9: [],
        // 分页数据
            dataTotal:10,
            pageNum:10,
    ...
    mounted(){
        ...
        let url = this.portA+this.constData.MT_FB_FB_Sort;
    ...
    methods:{
        ...
        // 导出数据
            exportData(){
                ...
                window.location.href=this.portA+this.constData.MT_FB_FB_Export+"?hpobj="+par.hpobj+"&starttime="+par.starttime+"&endtime="+par.endtime
            },
    // 获取搜索日期
        getStartTime(value){
