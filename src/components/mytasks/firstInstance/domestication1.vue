            ...
            <Content :style="{padding: '0 16px 16px'}">
                <Breadcrumb :style="{margin: '16px 0',display:'flex', justifyContent: 'space-between'}">                   
                    ...
                    <span>
                        ...
                        <el-button type="info" size="small">&nbsp;审核未通过&nbsp;</el-button>                    
                    </span>
                </Breadcrumb>                             
                <Card> 
                    ...
                    <Modal
                        ...
                        <div slot="footer">
                            ...
                            <Modal v-model="m4" draggable :title=data4.otherdata @on-ok="data4S()" @on-cancel="cancel()" >
                                <Select v-model="data4.feedback" style="width:100px">
                                    <Option v-for="(item,index) in data4.lists" :value="item" :key="index">{{ item }}</Option>
                                </Select>
                            </Modal> 
                        </div>   
                    </div>
...
export default {
    ...
    methods:{
        ...
        data4S(){
            ...
            if(par.feedback == par.customfield3){
                par.feedback = 0
            }else{
                par.feedback = 1
            }
        ...
        // 返回
        goBack(){
           this.$router.push({path:'/firstInstanceLists',query:{FD: this.$route.query.condition}})
        }
    }
}
</script>
...
.domestication1{min-width: 800px;
