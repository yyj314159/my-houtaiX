...
export default {
    ...
    data () {
        return {
            portA: ports.a,
            // 表格内容
            columns13: [{title: '区域', align: 'center', key: 'area'},{title: '省份', align: 'center', key: 'province'},{title: 'DSR编号', align: 'center', key: 'dsrnum'},{title: '原始得分', align: 'center', key: 'originalscore'},{title: '标准得分', align: 'center', key: 'standardscore'},
                {title: '商店总数', align: 'center', key: 'shopsum'},{title: 'A+店数', align: 'center', key: 'aasum'},{title: 'A店数', align: 'center', key: 'asum'},{title: 'B店数', align: 'center', key: 'bsum'},{title: 'C店数', align: 'center', key: 'csum'},
                {title: 'D店数', align: 'center', key: 'dsum'},{title: '样本总数', align: 'center', key: 'samplesum'},{title: 'DSR排名', align: 'center', key: 'ranking'}],
            data13: [],
        // 分页数据
            dataTotal:10,
            pageNum:10,
    ...
    mounted(){
    // 请求列表总数据
        let url = this.portA + this.constData.RM_FR_SR;
    ...
    //导出表格数据
        exportData(){
            window.location.href= this.portA+this.constData.RM_FR_DR_Export+"?hpid="+this.$route.query.id+"&id=2"
        },
    // 换页操作
        changPage(page){
            this.data13 = []
