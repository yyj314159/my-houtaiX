...
.wrop{width: 100%;height: 600px;display: flex;justify-content: space-between;
   .left{width: 55%;height: 100%; border: 1px solid #000;}
   .tab{width: 100%;height: 570px;border: 1px solid green;overflow: auto}
   .right{width: 44%;height: 100%;
       .top{height: 400px;width: 100%;
            
            ul{width: 100%;height: 380px;overflow: auto;border: 1px solid orange;
            // display: flex;flex-wrap:wrap;
               li{width: 100%;height: 132px;border: 1px solid #000;margin: 3px;display: flex;justify-content: space-between;
